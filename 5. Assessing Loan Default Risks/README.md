...
```
Assessing_Loan_Default_Risks/
│
├── data/
│   └── Loan_Default.csv                          # Raw mortgage loan dataset (~148K records)
│
├── notebooks/
│   └── Assessing_Loan_Default_Risks_Using_Python.ipynb  # Main analysis notebook (4 milestones)
│
├── docs/
│   └── Assessing_Loan_Default_Risks.docx         # Project report and problem statement
│
...
M.S., Data Science — Bellevue University  
Course: DSC 540 Data Preparation  
[LinkedIn](https://www.linkedin.com/in/mathankumartk/) | [GitHub](https://github.com/mathankumartk/mathankumartk.github.io)
